<template>
	<view class="bg">
		...
		<scroll-view scroll-with-animation :scroll-y="isScroll" :scroll-top="scrollTop" style="width: 100%;padding-top: 140px;">
			<!-- 用来获取消息体高度 -->
				...
				<view class="flex-column-start" v-for="(x,i) in msgList" :key="i">
					...
					<view v-if="x.my" class="userinfo">
						<view class="flex justify-end my-info">
							<view class="usermsg" style="max-width: 500px;">
								<text style="word-break: break-all;">{{x.msg}}</text>
							</view>
							<view class="chat-img" style="margin-left:20px ;">
								<image style="height: 100px;width: 100px;" :src="userAvatar" mode="aspectFit">
								</image>
							</view>
						</view>
					</view>
					...
					<view v-if="!x.my" class="aiinfo">
						<view class="chat-img ">
							<image style="height: 100px;width: 100px;" src="../../static/9.jpg" mode="scaleToFill">
							</image>
						</view>
						<view class="flex" style="max-width: 500px;">
							<view class="aimsg" style="border-radius: 35px;background-color: #f9f9f9;">
								<text style="word-break: break-all;">{{x.msg}}</text>
							</view>
						</view>
					</view>
		...
		<view class="flex-column-center">
			<button class="btn" style="margin-bottom: 20px;width: auto;"
		...
		<!-- <uni-popup ref="popup" type="center">
			<view class="popcls">
				<view class="uni-textarea" style="width: 90%;margin: 20px 20px;border: 1px solid #000000;">
					<textarea style="width: 100%; " placeholder-style="color:#F76260" :placeholder="apiadj"
						v-model="api" />
				</view>
				<view style="display: flex;flex-direction: row;">
					<button style="margin: 10px;" type="primary" @click="apiset">确认</button>
					<button style="margin: 10px;" @click="clopop">取消</button>
				</view>
			</view>
		</uni-popup> -->
	</view>
